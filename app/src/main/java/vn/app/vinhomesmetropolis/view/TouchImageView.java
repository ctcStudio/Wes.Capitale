package vn.app.vinhomesmetropolis.view;
...
public class TouchImageView extends ImageView {
    ...
    private class DoubleTapZoom implements Runnable {
        ...
        private float interpolate() {
            return this.interpolator.getInterpolation(Math.min(IPhotoView.DEFAULT_MIN_SCALE, ((float) (System.currentTimeMillis() - this.startTime)) / ZOOM_TIME));
        }
    ...
    private void sharedConstructing(Context context) {
        ...
        this.normalizedScale = IPhotoView.DEFAULT_MIN_SCALE;
        if (this.mScaleType == null) {
            this.mScaleType = ScaleType.FIT_CENTER;
        }
        this.minScale = IPhotoView.DEFAULT_MIN_SCALE;
    ...
    public boolean isZoomed() {
        return this.normalizedScale != IPhotoView.DEFAULT_MIN_SCALE;
    }
    ...
    public float getRealWidth() {
        return this.prevMatchViewWidth;
    }

    public float getRealHeight() {
        return this.prevMatchViewHeight;
    }
    ...
    private void fitImageToView() {
        ...
        if (drawable != null && drawable.getIntrinsicWidth() != 0 && drawable.getIntrinsicHeight() != 0 && this.matrix != null && this.prevMatrix != null) {
            ...
            switch (C02551.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType.ordinal()]) {
                case 1:
                    scaleY = IPhotoView.DEFAULT_MIN_SCALE;
                    scaleX = IPhotoView.DEFAULT_MIN_SCALE;
                    break;
                case 2:
                    ...
                    break;
                case 3:
                    scaleY = Math.min(IPhotoView.DEFAULT_MIN_SCALE, Math.min(scaleX, scaleY));
                    scaleX = scaleY;
                    break;
                case 4:
                    break;
    ...
    public boolean canScrollHorizontally(int direction) {
        ...
        if ((Math.abs(x) + ((float) this.viewWidth)) + IPhotoView.DEFAULT_MIN_SCALE < getImageWidth() || direction <= 0) {
            return true;
        }
        return false;
    }
